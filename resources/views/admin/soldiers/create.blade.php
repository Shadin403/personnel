...
<div class="max-w-5xl mx-auto space-y-10 animate-fade-in pb-20">
    ...
    <div class="flex items-center justify-between pb-6 border-b border-slate-300">
        <div class="flex items-center gap-5">
            ...
            <div>
                <h2 class="text-3xl font-bold text-slate-900 tracking-tight uppercase">Personnel Enrollment [সদস্য অন্তর্ভুক্তি]</h2>
                <p class="text-[11px] font-semibold text-slate-500 uppercase tracking-widest mt-1">Initialize New Strategic Node Activation</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.soldiers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
        ...
        <div class="classic-card overflow-hidden border border-slate-300">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-8 bg-white">
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">No. (Service Number) *</label>
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Force Classification *</label>
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Designated Rank</label>
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Appt (Appointment)</label>
        ...
        <div class="classic-card overflow-hidden border border-slate-300">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-8 bg-white">
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Coy. (Company)</label>
                ...
                <div class="md:col-span-3">
                    <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1 mb-3 block">Personnel Visual Identification (HD PHOTO)</label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="classic-card overflow-hidden border border-slate-300">
                ...
                <div class="p-8 space-y-6 bg-white">
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Biannual Matrix 01</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Biannual Matrix 02</label>
            ...
            <div class="classic-card overflow-hidden border border-slate-300">
                ...
                <div class="p-8 grid grid-cols-2 gap-4 bg-white">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">ETS (Firing/test sub-score)</label>
        ...
        <div class="classic-card overflow-hidden border border-slate-300">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 bg-white">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">spd March</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Gren Fire</label>
                    ...
                    <div class="space-y-1.5 col-span-2">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Commander Auth Status</label>
                ...
                <div class="space-y-6">
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-secondary uppercase tracking-widest ml-1">Course/Cdr Completed</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-military-primary uppercase tracking-widest ml-1">Course/Cdr Plan This Yr</label>
