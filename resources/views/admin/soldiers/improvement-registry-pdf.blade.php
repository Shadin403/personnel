...
<body>
                ...
                <tbody>
                    @foreach ($ipft_fails as $index => $s)
                        <tr>
                            ...
                            <td
                                class="{{ in_array(strtoupper($s->ipft_biannual_1), ['FAIL', 'FAILED', 'F']) ? 'status-fail' : '' }}">
                                {{ $s->ipft_biannual_1 }}
                            </td>
                            <td
                                class="{{ in_array(strtoupper($s->ipft_biannual_2), ['FAIL', 'FAILED', 'F']) ? 'status-fail' : '' }}">
                                {{ $s->ipft_biannual_2 }}
                            </td>
                        </tr>
                    @endforeach
    ...
    {{-- <div style="margin-top: 50px; text-align: right;">
        <div
            style="display: inline-block; border-top: 1px solid #000; padding: 5px 30px; font-weight: bold; font-size: 12px;">
