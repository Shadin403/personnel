                        ...
                        <div class="p-8 space-y-8">
                            ...
                            <div class="space-y-2">
                                <label class="text-[11px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                                    <span class="w-6 h-6 bg-military-primary text-white flex items-center justify-center text-[10px]">০</span>
                                    ইউজার টাইপ (User Type)
                                </label>
                                <select name="user_type" class="w-full p-4 tactical-input text-sm font-bold @error('user_type') border-red-500 @enderror" required>
                                    ...
                                    <option value="Snk" {{ old('user_type', $soldier->user_type) == 'Snk' ? 'selected' : '' }}>Snk</option>
                                </select>
                                @error('user_type')
