            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    ...
                    <div class="p-8 space-y-8 w-full text-left">
                        ...
                        <div class="space-y-4 text-left">
                            <div class="flex justify-between items-end">
                                ...
                                <span class="text-[13px] font-bold {{ $soldier->ipft_biannual_1 == 'Excellent' ? 'text-military-success' : ($soldier->ipft_biannual_1 == 'Failed' ? 'text-military-danger' : 'text-military-primary') }} underline decoration-2 underline-offset-4">{{ $soldier->ipft_biannual_1 ?? 'Untested' }}</span>
                            </div>
                        ...
                        <div class="space-y-4 text-left">
                            <div class="flex justify-between items-end">
                                ...
                                <span class="text-[13px] font-bold {{ $soldier->ipft_biannual_2 == 'Excellent' ? 'text-military-success' : ($soldier->ipft_biannual_2 == 'Failed' ? 'text-military-danger' : 'text-military-primary') }} underline decoration-2 underline-offset-4">{{ $soldier->ipft_biannual_2 ?? 'Untested' }}</span>
                            </div>
                            <div class="h-3 w-full bg-military-bg border border-slate-200 overflow-hidden">
                ...
                <div class="classic-card border border-slate-300 overflow-hidden text-left bg-white shadow-md">
                    ...
                    <div class="p-8 grid grid-cols-2 gap-8 text-left bg-white/50">
                        <div class="text-left">
                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3 text-left">spd March</p>
                            <div class="flex items-center gap-3">
                                <span class="text-xl font-bold text-military-secondary tracking-tighter">{{ $soldier->speed_march ?? 'N/A' }}</span>
                            </div>
                        </div>
                        <div class="text-left">
                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3 text-left">Gren Fire</p>
                            <div class="flex items-center gap-3 font-mono">
                                <span class="text-xl font-bold text-military-secondary">{{ $soldier->grenade_fire ?? '0%' }}</span>
                            </div>
                        </div>
                        <div class="text-left">
                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3 text-left">Nil Fire</p>
                            <div class="flex items-center gap-3 font-mono">
            ...
            <div class="classic-card border border-slate-300 overflow-hidden text-left bg-white shadow-xl">
                <div class="px-10 py-8 bg-military-danger flex flex-col md:flex-row md:items-center justify-between gap-6 border-b-4 border-military-secondary/20">
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            <h3 class="text-[13px] font-bold text-white uppercase tracking-widest">Firing Result Section (Ret)</h3>
                ...
                <div class="p-10 grid grid-cols-2 md:grid-cols-4 gap-12 text-left bg-military-bg/30">
                    <div class="space-y-3 text-left">
                        <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest text-left">Shoot to hit [টার্গেটে hit score]</p>
